...
pub use super::measurements::XYZ;
pub use super::registers::Register;
pub use super::settings::accel::AccelSettings;
pub use super::settings::gyro::GyroSettings;
    ...
    I: Interface,
{
    ...
    pub fn is_reachable(&mut self) -> Result<bool, I::Error> {
        Ok(self.read_register(Register::WHO_AM_I.addr())? == LSM6DS3TR_ID)
    }
